...
echo "${GREEN}${bold} Installing kdenlive, krita, ffmpeg, build-essential, kate, shellcheck, flake8, cppcheck, nmap, zenkit, moc, moc-ffmpeg-plugin, nvim
blender, libreoffice, discord, Inkscape, gnomeBoxes, godotengine, videodownloader, Nixwriter, libllvm6.0, Audacity, OBS ..${NC}${normal}"
sudo apt-get install kdenlive krita ffmpeg build-essential kate shellcheck flake8 cppcheck nmap moc moc-ffmpeg-plugin nvim -y
