...
echo "${GREEN}${bold} Installing kdenlive, ktorrent, krita, ffmpeg, build-essential, kate, shellcheck, nmap, moc, moc-ffmpeg-plugin, nvim, htop, moc, browsh, fzf
blender, libreoffice, discord, Inkscape, gnomeBoxes, godotengine, videodownloader, Nixwriter, libllvm6.0, Audacity, OBS ..${NC}${normal}"
sudo apt-get install kdenlive krita ktorrent ffmpeg build-essential kate shellcheck nmap moc moc-ffmpeg-plugin nvim htop moc browsh fzf -y
